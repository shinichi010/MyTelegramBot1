...
try:
    ...
    # تأكد من إضافة DATABASE_URL في إعدادات Railway
...
def main():
    ...
    # هاندلر استقبال وتحميل الهمسات بالخاص (المفقود اللي ضفته الك هسة)
    app.add_handler(MessageHandler(filters.ChatType.PRIVATE & filters.TEXT & ~filters.COMMAND, handle_private_whisper), group=0)
